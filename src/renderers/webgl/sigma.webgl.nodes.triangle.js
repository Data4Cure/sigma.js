  ...
  sigma.webgl.nodes.triangle = {
    ...
    initProgram: function(gl) {
	  ...
	  //'#define M_PI 3.1415926535897932384626433832795',
	      ...
	      'radius * vec2(cos((2.0/3.0) * 3.1415926535897932384626433832795 * a_nodeind + 3.1415926535897932384626433832795 / 6.0 - radians(a_rotate)), sin((2.0/3.0) * 3.1415926535897932384626433832795 * a_nodeind + 3.1415926535897932384626433832795 / 6.0 - radians(a_rotate)));',
